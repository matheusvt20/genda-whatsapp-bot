...
WHATSAPP_STATUS_OUTBOX_FAST_RETRY_MS=250
WHATSAPP_STATUS_OUTBOX_FAST_RETRY_ATTEMPTS=3
WHATSAPP_STATUS_OUTBOX_MAX_ATTEMPTS=8
WHATSAPP_STATUS_OUTBOX_FLUSH_BATCH_SIZE=10
